...
export function computeInventoryAvailability(context) {
  ...
  // docs/fix-protocol-error-reports.md #12. The former daysAfter=bufferDays+1 asymmetry was
...
export async function getBulkAvailableInventory(targetDate, modelIds = null) {
  ...
  // to bufferDays, matching Access's real production query. See computeInventoryAvailability
