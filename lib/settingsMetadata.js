...
export const SETTINGS_HEBREW_NAMES = {
  ...
  ai_screen_recording_enabled: 'אפשר הסרטת מסך בעוזר ה-AI',
...
export const SETTINGS_HEBREW_NOTES = {
  ...
  ai_screen_recording_enabled: 'מציג כפתור "הסרטת מסך" בעוזר ה-AI: מוסרט המסך (עד 90 שניות, עולה לדרייב) ובמקביל נרשמת רשימת הפעולות (לחיצות, הקלדות, ניווט; סיסמאות/אשראי/ת"ז מוסתרים), והכול נשלח לניתוח (עלות/זמן עיבוד גבוהים יותר מצילום מסך רגיל, לכן כבוי כברירת מחדל). דורש שהגשר לדרייב מוגדר בשרת.',
...
export const SETTINGS_BOOLEAN_KEYS = [
  ...
  'enable_batch_print_prep', 'same_model_swap_no_fee', 'ai_screen_recording_enabled',
