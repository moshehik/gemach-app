...
export const SETTINGS_HEBREW_NAMES = {
  ...
  ai_screen_recording_enabled: 'אפשר ניתוח הקלטות מסך בעוזר ה-AI',
...
export const SETTINGS_HEBREW_NOTES = {
  ...
  ai_screen_recording_enabled: 'מציג כפתור "הקלט מסך" בעוזר ה-AI ומאפשר לו לנתח הקלטות מסך של עד 90 שניות (עלות/זמן עיבוד גבוהים יותר מצילום מסך רגיל, לכן כבוי כברירת מחדל).',
