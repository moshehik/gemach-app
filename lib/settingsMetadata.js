...
export const SETTINGS_HEBREW_NOTES = {
  ...
  restrict_dress_catalog_to_head_management: 'כשמופעל, קטלוג הדגמים נגיש לצפייה רק להנהלה ראשית/מתכנת. יצירה/עריכה/מחיקה של דגם מוגבלות להנהלה ראשית תמיד, גם כשההגדרה כבויה. ההגדרה קובעת את ברירת המחדל לכל הארגון; מחלקה או עובד ספציפי אפשר להגדיר במסך ההרשאות ("קטלוג שמלות").',
  restrict_refunds_to_head_management: 'כשמופעל, עמוד זיכויים וחובות נגיש רק להנהלה ראשית/מתכנת ולא למנהל סניף רגיל. ההגדרה קובעת את ברירת המחדל לכל הארגון; מחלקה או עובד ספציפי אפשר להגדיר במסך ההרשאות ("זיכויים").',
  restrict_board_to_managers: 'כשמופעל (ברירת המחדל), הקישור "לוח חודשי" בסיידבר מוצג רק למנהל סניף/הנהלה ראשית/מתכנת - עובד רגיל לא רואה אותו. כשכבוי, הקישור מוצג לכל עובד מחובר. ההגדרה קובעת את ברירת המחדל לכל הארגון; מחלקה או עובד ספציפי אפשר להגדיר במסך ההרשאות ("לוח חודשי").',
...
export const SETTINGS_ORDER = {
  ...
  'הזמנות': [
    ...
    'draft_orders_show_as_deleted', 'enable_local_order_drafts', 'auto_print_on_order_create', 'phone_order_marker_enabled',
  ...
  'מלאי': ['allow_shift_lead_reserve_rental', 'enforce_rental_barcode_match'],
...
export const SETTINGS_BOOLEAN_KEYS = [
  ...
  'REFUND_REPAIRS', 'inventory_include_warehouse', 'allow_renting_reserve_items', 'allow_shift_lead_reserve_rental', 'enforce_rental_barcode_match', 'inventory_skip_weekends',
  'calendar_filtering',
  ...
  'agent_digest_email_enabled', 'restrict_board_to_managers', 'enable_local_order_drafts',
  ...
  'deliveries_select_by_event_date'
];
