 ...
 */
export async function sendSystemEmail({ to, subject, body, html, employeeId, attachments, fileName, fileContent, mimeType, sendMode = 'email', driveFolderId = '', grantFullDownload = true, confirmToken } = {}) {
  if (!to) {
