...
export async function applyDeliveryCharge(orderId) {
  try {
    ...
    // Neither a per-city price nor delivery_price configured - fall back to the documented
    // standard flat delivery charge (scripts/seed_settings.js: delivery_price = "50") instead
    // of silently skipping the charge entirely.
