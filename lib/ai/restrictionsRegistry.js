  ...
  // 4 --------------------------------------------------------------------------------------
  {
    ...
    restrictions: [
      ...
      },
      {
        ...
        wired: false,
        needsCodeChange: true,
        note: 'לממש צריך להרחיב את app/api/ai/smart-search/route.js: להוסיף רשימת עמודות בטוחות ל-"OrderItem" (ללא price/finalPrice) ולהשתמש בה ב-selectList כש-pageContext==="rentals" ו-restrictOrdersFinancialColumns אמת (כמו ORDERS_SAFE_COLUMNS היום), כולל בדיקת roleId זהה לזו שכבר קיימת עבור orders.',
        promptWhenEnabled: '',
        promptWhenDisabled: '',
      },
    ],
    presets: {
      strict: ['financial_columns_orders', 'strict_customer_name_matching'],
      standard: [],
      open: [],
    },
