...
export const PERMISSION_CATALOG = [
  ...
  approverItem({
    ...
    note: 'components/orders/modern/ModernGeneralDetails.js ו-components/orders/modern/ModernInfoTab.js (שני requestOrderDateEdit נפרדים, אותו שדה). עד 2026-09-23 קשיח: roleId 2 בלבד (מתכנת). כמו רוב הפריטים האחרים כאן, נאכף כרגע רק בלקוח (verify-pin) - אין עדיין בדיקה מקבילה בשרת ב-PUT /api/orders/[id] (data.orderDate נשמר שם בלי שום בדיקת הרשאה, ר\' סעיף בהערות ה-route) - קריאת API ישירה יכולה לעקוף. פער קיים גם קודם, לא נפתר כאן.',
