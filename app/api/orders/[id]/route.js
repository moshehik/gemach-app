...
export async function PUT(request, { params }) {
  try {
    ...
    try {
      ...
      // אם ללקוח אין ת"ז שמורה בכלל - ההזמנה קדמה לתקופה שבה ת"ז הייתה שדה חובה בכרטיס
      // לקוח, ואי אפשר לדרוש אימות מול נתון שמעולם לא נאסף - הדרישה מדולגת לגמרי במקרה כזה.
