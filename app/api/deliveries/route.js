...
export async function GET(request) {
  ...
  try {
    ...
    for (const order of orders) {
      ...
      // דיווח 1a02bcc5 - הזמנה עם כיוון משלוח יחיד ('הלוך' או 'חזור') הופיעה עם שתי החטיבות
      // כאילו נבחר 'הלוך-חזור' - כי הבדיקה כאן התבססה רק על טווח התאריכים בלי להתייחס בכלל
      // לכיוון שנבחר בהזמנה עצמה.
