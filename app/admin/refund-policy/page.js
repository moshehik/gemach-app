    ...
    <>
      ...
      <div className="content-page">
        ...
        <div className="content-toc">
          ...
          <a href="#arp-replacement">החלפת מידה לאותו דגם — ללא דמי ביטול</a>
        ...
        <h2 id="arp-replacement">החלפת מידה לאותו דגם — ללא דמי ביטול</h2>
        <p>
          אם באותה הזמנה מבוטל פריט וגם נשאר/נוסף פריט פעיל אחר <strong>של אותו דגם שמלה בדיוק</strong> (DressModel זהה,
          מידה שונה) — הצמד הזה מזוהה אוטומטית כ&quot;החלפת מידה&quot;: הפריט שבוטל מזוכה במלואו (בלי דמי ביטול כלל),
          ללא תלות בשלושת חלונות הזמן למעלה ובלי מגבלת זמן. בפועל הלקוח/ה משלמ/ת רק את ההפרש בין מחיר המידה הישנה
          לחדשה (אם יש). כל פריט פעיל משמש תחליף לכל היותר לפריט מבוטל אחד אחד. עלויות תיקונים (צוואר/שרוול/אורך)
          על הפריט שבוטל ממשיכות להיות חיוב קבוע כרגיל — לא מושפעות מהחלפת מידה.
        </p>
        <p>
          <strong>החלפת דגם (דגם שמלה שונה לגמרי)</strong> אינה נחשבת &quot;החלפת מידה&quot; ולא מקבלת את הפטור הזה —
          היא ממשיכה להתנהל לפי שלושת חלונות הזמן הרגילים למעלה (כלומר, במדיניות הנוכחית: 50% דמי ביטול על הפריט
          שבוטל, בנוסף למחיר המלא של הפריט החדש), בדיוק כמו ביטול רגיל.
        </p>
        ...
        <ul>
          <li>
            15.09.2026 — <strong>שונה:</strong> מנגנון &quot;זיכוי דמי ביטול על פריט חלופי&quot; (מבוסס-זמן, ללא קשר לדגם)
            הוחלף ב&quot;החלפת מידה לאותו דגם&quot; (ר&apos; סעיף למעלה) — מבוסס-דגם, ללא הגבלת זמן, ורק כשהדגם זהה.
            בעקבות בקשה מפורשת: החלפת מידה לא תיגבה דמי ביטול (רק הפרש מחיר), אבל החלפת דגם שונה כן תמשיך לגבות
            דמי ביטול מלאים כרגיל — גם אם בוצעה באותה ישיבה, מה שלא היה נכון תחת המנגנון הישן.
          </li>
