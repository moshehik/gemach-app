    ...
    <div style={{ direction: 'rtl' }}>
      <div className="page-head">
        <div>
          ...
          <div className="page-desc">יצירת הוראת קבע (הו&quot;ק) אצל נדרים פלוס, בדרך כלל בסכום סמלי ולתאריך עתידי - כדי שבמקרה של אי-החזרת פריט אפשר יהיה לערוך את פרטי ההוק ולגבות בפועל (בדפים האחרים למטה, או בממשק הניהול של נדרים פלוס).</div>
        </div>
      </div>

      <NedarimNav current="/admin/nedarim-hok-test" />

      <div className="callout callout-danger" style={{ marginBottom: 16 }}>
        <strong>שים לב:</strong> זהו דף ניסוי עצמאי, לא מחובר לתהליך ההזמנה/תשלום האמיתי. הפעולה שולחת בקשה אמיתית ל-API של נדרים פלוס מול קוד המוסד שתקליד - היא יוצרת הוק אמיתי, לא סימולציה. עריכה, הקפאה, מחיקה וגביית תשלום בודד על הוק קיים נעשות בדף &quot;שינוי הו&quot;ק&quot; למעלה - אין למחוק/לבטל דרך דף זה.
      </div>
