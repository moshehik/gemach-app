...
//
// דיווח dd108f1f (2026-09-14): התיקון הקודם (PR #17) השתמש ב-\b אחרי "שם", אבל
// \b ב-JS מבוסס על תווי \w אסקי בלבד (A-Za-z0-9_) - אותיות עבריות הן \W, אז \b
// כמעט אף פעם לא "נדלק" בין שתי אותיות עבריות/רווח/מקף. בפועל זה אומר שהרג'קס
// לא התאים אף אחד מהמקרים האמיתיים (למשל "ללא שם - 1236" או סתם "ללא שם" בלי
// שום המשך) - רק "ללא שם" שמודבק ישירות למספר בלי רווח. startsWith לא תלוי
// בהגדרת \w ועובד נכון לעברית.
