...
| **Payment** | `paymentDate` | תאריך תשלום | 0 | 41760 | **-41760** |
| **Payment** | `notes` | הערות | 0 | 28914 | **-28914** |
| **PaymentObligation** | `description` | תיאור | 6835 | 34121 | **-27286** |
| **PaymentObligation** | `isRefund` | זיכוי | 32000 | 142303 | **-110303** |
