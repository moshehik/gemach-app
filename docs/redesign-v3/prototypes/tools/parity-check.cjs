...
const C = [
  ...
  ['card', '.card:not(.hist)', ['padding-top', 'padding-inline-start', 'border-top-width', 'border-top-color', 'border-top-left-radius', 'background-color', 'box-shadow'], 0],
  ['card header h2', '.card-h h2', ['font-size', 'font-weight', 'color'], 0],
  ['card header icon', '.card-h .ico', ['width', 'height', 'border-top-left-radius'], 1],
  ['label/value row', '.kv .f', ['padding-top', 'gap', 'border-bottom-color'], 0],
