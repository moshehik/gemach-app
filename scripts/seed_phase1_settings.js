...
const newSettings = [
  ...
  { key: 'bulk_email_by_event_date', name: 'שליחת מייל לפי תאריך אירוע', value: 'true', category: 'אוטומציה', notes: 'מאפשר לשלוח מייל לכל הלקוחות שיש להם אירוע בתאריך/טווח מסוים + מעקב מי אישר/לא אישר.', type: 'boolean' },
